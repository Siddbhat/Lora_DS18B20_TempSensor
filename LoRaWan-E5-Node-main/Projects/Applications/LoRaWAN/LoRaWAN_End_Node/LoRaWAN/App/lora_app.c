...
void LoRaWAN_Init(void)
{
  ...
  UTIL_TIMER_SetPeriod(&TxLedTimer, 300);
  UTIL_TIMER_SetPeriod(&RxLedTimer, 500);
  UTIL_TIMER_SetPeriod(&JoinLedTimer, 300);
...
//  uint16_t pressure = 0;
  ...
  uint16_t humidity = 65535;
  uint16_t pressure =65535;
//  sensor_t sensor_data;
  ...
  temperature = temp_data  * 100;

  APP_LOG(TS_ON, VLEVEL_L, "Temp  : ~%s \r\n", str);
